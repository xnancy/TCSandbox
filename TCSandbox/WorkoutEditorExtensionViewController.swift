...
extension WorkoutEditorViewController: UIViewControllerPreviewingDelegate {
...
//        guard let previewVC = storyboard?.instantiateViewControllerWithIdentifier("PreviewVC2") as? PreviewViewController
//            else{ return nil }
//        
